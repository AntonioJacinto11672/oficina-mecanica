...
class Estoque {
    ...
    public function index() {
        ...
        $this->dadosCategoria();
        $this->dadosProdutos();
        $carregarView = new \Core\ConfigView("adms/Views/produto/pgEstoque", $this->dados, $this->dadosAlter, $this->dadosPaginacao);
    ...
    private function dadosProdutos() {
        $dados = new \App\adms\Models\AdmsMecanico();
        $this->dados = $dados->dadosProdutosEstoqueBaixo();
    }
