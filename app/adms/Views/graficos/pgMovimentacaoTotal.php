...
<div class = "container-fluid">
        ...
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Estatística</h1>
        <p class="mb-4">Grafico de Movimentação <a
                target="_blank" href=""> Consultar Movimentação</a>.</p>
            ...
            <div class="col-xl-12 col-lg-12">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Gráfico de toda Movimentações</h6>
                    </div>
                    <div class="card-body">
                        <figure class="highcharts-figure">
                            ...
                            <hr>
                                O Gráfico Seguinte Mostra As Todas Movimentações Entradas e Saídas do Ano Corrente de <?php echo date("Y");?> em cada Mês Até O Mês Atual
